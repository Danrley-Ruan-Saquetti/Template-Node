...
async function create<T extends UserCreateArgs>(args: T) {
    const response: Result<UserCreateResponse> = await database.user.create(args).then((res) => {
...
async function createMany<T extends UserCreateManyArgs>(args: T) {
    const response: Result<UserCreateManyResponse> = await database.user.createMany(args).then((res) => {
        return Result.success(res)
    }).catch(err => {
        return Result.failure({ title: 'Register Users', message: [{ message: 'Cannot register users', origin: 'user' }] }, 400)
    })
...
async function update<T extends UserUpdateArgs>(args: T) {
    const response: Result<UserUpdateResponse> = await database.user.update(args).then((res) => {
        return Result.success({ user: res })
    }).catch(err => {
        return Result.failure({ title: 'Update User', message: [{ message: 'Cannot update user', origin: 'user' }] }, 400)
    })
...
async function updateMany<T extends UserUpdateManyArgs>(args: T) {
    const response: Result<UserUpdateManyResponse> = await database.user.updateMany(args).then((res) => {
        return Result.success(res)
    }).catch(err => {
        return Result.failure({ title: 'Update Users', message: [{ message: 'Cannot update users', origin: 'user' }] }, 400)
    })
...
async function findFirst<T extends UserFindFirstArgs>(args: T) {
    const response: Result<UserFindFirstResponse<T>> = await database.user.findFirst(args).then((res) => {
        return Result.success({ user: res })
    }).catch(err => {
...
async function findUnique<T extends UserFindUniqueArgs>(args: T) {
    const response: Result<UserFindUniqueResponse<T>> = await database.user.findFirst(args).then((res) => {
        return Result.success({ user: res })
    }).catch(err => {
        return Result.failure({ title: 'Find User', message: [{ message: 'Cannot find user', origin: 'user' }] }, 400)
...
async function findFirstOrThrow<T extends UserFindFirstOrThrowArgs>(args: T) {
    const response: Result<UserFindFirstOrThrowResponse<T>> = await database.user.findFirstOrThrow(args).then((res) => {
        return Result.success({ user: res })
    }).catch(err => {
        return Result.failure({ title: 'Find User', message: [{ message: 'Cannot find user', origin: 'user' }] }, 400)
...
async function findUniqueOrThrow<T extends UserFindUniqueOrThrowArgs>(args: T) {
    const response: Result<UserFindUniqueOrThrowResponse<T>> = await database.user.findFirstOrThrow(args).then((res) => {
        return Result.success({ user: res })
    }).catch(err => {
        return Result.failure({ title: 'Find User', message: [{ message: 'Cannot find user', origin: 'user' }] }, 400)
...
async function findMany<T extends UserFindManyArgs>(args: T) {
    const response: Result<UserFindManyResponse<T>> = await database.user.findMany(args).then((res) => {
        return Result.success({ users: res })
    }).catch(err => {
        return Result.failure({ title: 'Find Users', message: [{ message: 'Cannot find users', origin: 'user' }] }, 400)
...
async function remove<T extends UserDeleteArgs>(args: T) {
    const response: Result<UserDeleteResponse> = await database.user.delete(args).then((res) => {
        return Result.success(true)
    }).catch(err => {
        return Result.failure({ title: 'Remove User', message: [{ message: 'Cannot remove user', origin: 'user' }] }, 400)
    })
...
async function removeMany<T extends UserDeleteManyArgs>(args: T) {
    const response: Result<UserDeleteManyResponse> = await database.user.deleteMany(args).then((res) => {
        return Result.success(res)
    }).catch(err => {
        return Result.failure({ title: 'Remove Users', message: [{ message: 'Cannot remove users', origin: 'user' }] }, 400)
    })
